import './HomeOperation/HomeOperations.css';
...
export default function HomeOperations() {
  ...
  const pdfUrl = 'Doc9.docx'; // Replace with the actual URL of your PDF file
  ...
  const sortUserOperations = () => {
    ...
    switch(sortingCriteria) {
      ...
      case "Online_Transfer":
        sortedOperations = userOperations.filter((operation) => operation.way_of_payment === "Online_Transfer");
        break;
      case "Credit_Card":
